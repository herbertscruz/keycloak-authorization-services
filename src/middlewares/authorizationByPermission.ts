...
const debug = debugPkg('keycloak-authorization-service:authorization-by-permission');
...
export default function authorizationByPermission(config: KeycloakAuthorizationConfig, params: KeycloakAuthorizationByPermission): RequestHandler {
